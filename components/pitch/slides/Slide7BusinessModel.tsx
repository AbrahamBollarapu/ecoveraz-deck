    ...
    <div className="grid gap-4 md:grid-cols-3">
      ...
      <Card title="ARR Impact (interactive)" desc="Adjust assumptions to see subscription ARR.">
        <div className="mt-4 rounded-xl border border-line bg-bg p-4">
          <div className="text-sm font-semibold">Subscription ARR estimator</div>
        ...
        <div className="mt-4 rounded-xl border border-line bg-bg p-4">
          <div className="text-sm font-semibold">Gross margins (targets)</div>
          <div className="mt-2 grid grid-cols-2 gap-2 text-sm text-sub">
            <div className="rounded-lg border border-line bg-surface px-3 py-2">Software: <b>85%</b></div>
            <div className="rounded-lg border border-line bg-surface px-3 py-2">Hardware: <b>45%</b></div>
            <div className="rounded-lg border border-line bg-surface px-3 py-2">Services: <b>70%</b></div>
            <div className="rounded-lg border border-line bg-surface px-3 py-2">Overall: <b>68%</b></div>
          </div>
        </div>
      </Card>
      ...
      <Card title="Cost Comparison" desc="Traditional audits vs EcoVeraZ. (placeholder)">
        <div className="mt-4 rounded-xl border border-line bg-bg p-4">
          <div className="text-sm font-semibold">Traditional audit</div>
          <div className="mt-2 text-sm text-sub">6–9 months • manual evidence • high verification cost</div>
        </div>
        <div className="mt-3 rounded-xl border border-line bg-bg p-4">
          <div className="text-sm font-semibold">EcoVeraZ</div>
          <div className="mt-2 text-sm text-sub">Continuous measurement • automated evidence • receipt-based verification</div>
        </div>
      </Card>
    </div>
  );
