...
export function Slide11Moat() {
  ...
  return (
    <div className="h-full w-full">
      {/* MOBILE: single narrative card (no click UI) */}
      <div className="block md:hidden space-y-4">
        <Card title="Moat" desc="Five layers competitors must breach.">
          <div className="mt-4 rounded-2xl border border-line bg-bg p-4">
            ...
            <div className="mt-4 text-xs font-mono text-sub">ACTIVE LAYER</div>
            <div className="mt-2 text-base font-semibold">{current.title}</div>
            <ul className="mt-3 list-disc pl-5 text-sm text-sub space-y-2">
          ...
          <div className="mt-4 grid gap-2">
            {LAYERS.map((l) => (
              ...
              >
                ...
                <div className="mt-2 text-xs text-sub">{l.bullets.join(" • ")}</div>
              </button>
            ))}
          </div>
        </Card>

        <Card title="Board takeaway" desc="Why this is defensible.">
          <div className="mt-4 rounded-xl border border-line bg-bg p-4 text-sm text-sub">
            EcoVeraZ combines physical measurement, compliance gates, and verification infrastructure —
            creating layered defensibility that compounds over time.
          </div>
        </Card>
      </div>

      {/* TABLET/DESKTOP: keep your interactive 3-col rings layout */}
        ...
        <Card title="Moat Rings" desc="Concentric layers (outer → inner).">
          <div className="mt-4 rounded-2xl border border-line bg-bg p-5">
            <div className="relative mx-auto h-56 w-56">
              <Ring inset={0} tone="neutral" />
              <Ring inset={18} tone="neutral" />
              <Ring inset={36} tone="neutral" />
              <Ring inset={54} tone="neutral" />
          ...
          <div className="mt-4 space-y-3">
            <div className="rounded-xl border border-line bg-bg p-4">
              ...
              <div className="mt-2 text-sm text-sub">
                Patent diagrams + claims cards land when logos/diagrams are ready.
              </div>
            </div>
            <div className="rounded-xl border border-line bg-bg p-4">
              <div className="text-sm font-semibold">Moat deepening over 5 years (placeholder)</div>
              <div className="mt-2 text-sm text-sub">
                Timeline chart: defensibility accumulation vs competitors.
              </div>
            </div>
            <div className="rounded-xl border border-line bg-bg p-4">
              <div className="text-sm font-semibold">Competitor breach animation (placeholder)</div>
              <div className="mt-2 text-sm text-sub">
                Week 5 polish: subtle attempt/fail animation with 300ms transitions.
              </div>
            </div>
