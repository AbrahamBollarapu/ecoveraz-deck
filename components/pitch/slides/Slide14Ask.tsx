...
export function Slide14Ask() {
  ...
  // simplistic return: equity% * exit / investment
    ...
    <div className="grid gap-4 md:grid-cols-3">
      <Card title="The Ask" desc="Investment opportunity.">
        <div className="mt-4 rounded-xl border border-line bg-bg p-5">
          ...
          <div className="mt-3 text-sm text-sub">Valuation: <b>$14M post-money</b></div>
      ...
      <Card title="Return Calculator (interactive)" desc="Exit scenario sensitivity.">
        <div className="mt-4 rounded-xl border border-line bg-bg p-4">
          ...
          <input className="mt-2 w-full accent-evz-green" type="range" min={200} max={1000} step={50} value={exit}
          ...
          <div className="mt-4 rounded-xl border border-line bg-surface p-4">
            ...
            <div className="mt-1 text-sm text-sub font-mono">Invest: ${investment}M • Equity: {equity}% • Post: ${post}M</div>
  ...
  return (
    <div className="rounded-xl border border-line bg-bg p-4">
      <div className="flex items-center justify-between">
        ...
        <div className="text-xs font-mono text-sub">{pct}% • {amt}</div>
      </div>
      {bullets.length ? (
